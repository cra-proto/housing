...
alphaBanner.insertAdjacentHTML('afterbegin', '<section class="experimental alpha-top" role="banner"><h2 class="wb-inv">Cette page Web est en version alpha</h2><div class="container"><small><span class="alpha-label">Alpha</span>&nbsp;&nbsp; Il s\'agit d\'une version expémentale de Canada.ca destinée à être testée par le public.</small></div></section>');
